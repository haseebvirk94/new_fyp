...
class SingleCourse extends Component {
  ...
  takeTest = () => {
    this.setState({ conceptLoaded: false });
    let url =
      this.props.url + "/api/conceptincourse/?id=" + this.props.Courseid;
    axios.get(url).then((res) => {
      let concepts = res.data.Content;
      let ids = [];
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                      ...
                      <div
                        class="corses-singel-image pt-50"
                        style={{ marginTop: "30px" }}
                      >
                        <img
                          src={
                            this.state.imageUrl + this.state.courses.thumbnail
                          }
                          alt="Courses"
                        />
                      </div>
                                    ...
                                    {this.state.assessments.map((obj, key) => {
                                      return (
                                        <div class="card">
                                          ...
                                          <div
                                            id={"collapseSeven" + key}
                                            class="collapse"
                                            aria-labelledby="headingSeven"
                                            data-parent="#accordionExample"
                                          >
                                            <div class="card-body">
                                              {this.state.conceptLoaded
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-6">
                        <div class="course-features mt-30">
                          ...
                          <ul>
                            <li>
                              <i class="fa fa-clock-o"></i>Duaration :{" "}
                              <span>10 Hours</span>
                            </li>
                            <li>
                              <i class="fa fa-clone"></i>Leactures :{" "}
                              <span>09</span>
                            </li>
                            <li>
                              <i class="fa fa-beer"></i>Quizzes :{" "}
                              <span>05</span>
                            </li>
                            <li>
                          ...
                          <div class="row">
                            ...
                            {this.props.User.isLoggedIn ? (
                              <div
                                class="price-button pt-10 col s6"
                                style={{ marginTop: "30px" }}
                              >
                                <button onClick={this.enroll} class="main-btn">
                                  Enroll Now
                                </button>
                              </div>
                            ) : (
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(SingleCourse)
);
