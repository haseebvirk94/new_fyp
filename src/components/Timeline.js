...
const mapDispatchToProps = (dispatch) => ({
  ...
  currentenrollment: (id) => dispatch({ type: "setEnrollment", payload: id }),
});
class Timeline extends Component {
  ...
  componentDidMount = () => {
    ...
    let url =
      this.props.url +
      "/api/assessmentenrollment/?user_id=" +
      this.props.User.id +
      "&course_id=" +
      this.props.Courseid;
        ...
        <div class="col-md-12">
          <div class="udb">
            <div class="udb-sec udb-time">
              <h4>
                <img src="images/icon/db4.png" alt="" /> Time Line
              </h4>
              <p></p>
                ...
                <ul>
                  {this.state.isLoaded ? (
                    this.state.sections.map((obj, key) => {
                      return (
                        <div>
                          {(obj.active || obj.completed) && !obj.loaded
                            ? this.getStatus(key)
                            : null}
                                      ...
                                      <h5>
                                        ...
                                        <span>
                                          ...
                                          this.state.enrolling ? (
                                            <button
                                              className="sdb-cl-class-name-btn   "
                                              onClick={() =>
                                                this.assessment(obj.id)
                                              }
                                            >
                                              Start Quiz
                                            </button>
                                            ...
                                            <button
                                              disabled
                                              className="sdb-cl-class-name-grey"
                                            >
                                              {" "}
                                              Start Quiz
                                            </button>
                                        ...
                                        <li>
                                          ...
                                          <div class="sdb-cl-class-name">
                                            <h5>
                                              {o.name}{" "}
                                              <span>
                                                {obj.completed || obj.active ? (
                                                  <button
                                                    className="sdb-cl-class-name-btn   "
                                                    onClick={() =>
                                                      this.startQuiz(o, obj.enr)
                                                    }
                                                  >
                                                    Start Quiz
                                                  </button>
